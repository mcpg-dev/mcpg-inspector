...
Design: `docs/inspector/rfcs/0001-architecture-and-design.md` in the
monorepo.
...
This repository is a read-only mirror from the mcpg monorepo — issues
welcome here, code changes happen upstream.
